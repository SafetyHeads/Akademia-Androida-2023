...
class LaunchScreenActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // inflate FrameLayout with Footer component
        val footer = Footer()
        ...
        val sfStart = welcomeMessageTxT.indexOf(resources.getString(R.string.company_name))
        val sfEnd = sfStart + resources.getString(R.string.company_name).length
