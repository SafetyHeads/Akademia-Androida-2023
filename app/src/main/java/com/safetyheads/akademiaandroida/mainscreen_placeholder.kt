...
class mainscreen_placeholder : Fragment() {
    ...
    override fun onCreateView(
        ...
        loginButton.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.login_placeholder)
        }
        val notloggedButton = view.findViewById<Button>(R.id.notloggedin)
        notloggedButton.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.notlogged_placeholder)
        }
        return view
    }
    }
