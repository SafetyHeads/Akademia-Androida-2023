...
class AddImageToFirebaseUserProfileFirestore(private val repository: UserRepository) :
    BaseUseCase<AddImageToFirebaseUserProfileFirestore.ProfileParam, Boolean> {

    class ProfileParam(val userUUID: String, val imageStringReference: String) : BaseUseCase.Params
