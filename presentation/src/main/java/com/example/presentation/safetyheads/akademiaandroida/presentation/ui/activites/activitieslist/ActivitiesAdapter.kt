package com.example.presentation.safetyheads.akademiaandroida.presentation.ui.activites.activitieslist
...
class ActivitiesAdapter(private val list: List<String>, private val context: Context) :
    ...
    class MyViewHolder(binding: CardBinding) : ViewHolder(binding.root) {
