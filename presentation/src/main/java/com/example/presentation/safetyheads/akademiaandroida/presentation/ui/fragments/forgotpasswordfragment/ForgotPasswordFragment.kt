package com.example.presentation.safetyheads.akademiaandroida.presentation.ui.fragments.forgotpasswordfragment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        forgotPasswordViewModel.isSuccess.observe(viewLifecycleOwner) { isSuccess ->
            if (isSuccess) {
                ...
                com.example.presentation.safetyheads.akademiaandroida.presentation.ui.components.snackbar.LoginSnackBar.make(
                    binding.root,
